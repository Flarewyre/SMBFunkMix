...
class SMMHUD extends FlxTypedGroup<FlxBasic>
{
	...
	public function new()
	{
		...
		var UIBox:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('UI/default/smm/bg'));
		...
		ratingIcon = new FlxSprite(0, 
			barY + (1 * 6)).loadGraphic(Paths.image("UI/default/smm/rankings"), true, 8, 8);
		...
		flagIcon = new FlxSprite(0, barY + (1 * 6)).loadGraphic(Paths.image("UI/default/smm/flags"), true, 8, 8);
